...
namespace Dobachesky_Lab3
{
    public partial class Default : System.Web.UI.Page
    {
        ...
        protected void btnGetForecast_Click(object sender, EventArgs e)
        {
            ...
            //Create Request
            String WeatherURL = "http://api.wunderground.com/api/[API_KEY]/forecast/q/MA/Boston.xml";
        ...
        protected void btnGetZipCities_Click(object sender, EventArgs e)
        {
            ...
            //Create Request
            String WeatherURL = "http://api.geonames.org/postalCodeSearch?postalcode=" + txtZip.Text + "&maxRows=10&username=[USER_NAME]&style=full";
        ...
        protected void btnGetNearby_Click(object sender, EventArgs e)
        {
            ...
            //Create Request
            String WeatherURL = "http://api.geonames.org/findNearbyPostalCodes?postalcode=" + txtZip.Text + "&country=US&radius=10&username=[USER_NAME]&style=full";
